...
import { ArrowRight, MapPin, Package, Zap, Bike, ShieldCheck, LineChart, ShoppingCart, Store, Lock, Mail, X } from "lucide-react";
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <button
                    ...
                    onClick={() => handleGoogleLogin("customer")}
                    disabled={loadingRole !== null}
                    className="dz-btn-brand inline-flex items-center gap-2 !text-sm !py-3 !px-5"
                  >
                  ...
                  <button
                    ...
                    disabled={loadingRole !== null}
                    className="dz-btn inline-flex items-center gap-2 !bg-[#22C55E] !text-black !text-sm !py-3 !px-5 border-2 border-black font-bold shadow-[3px_3px_0px_0px_#000]"
                  >
                    {loadingRole === "merchant" ? "Connecting..." : "Merchant Portal"} <Store className="w-4 h-4" strokeWidth={2.5} />
                  </button>
                  <button
                    onClick={() => handleGoogleLogin("concierge")}
                    disabled={loadingRole !== null}
                    className="dz-btn-amber inline-flex items-center gap-2 !text-sm !py-3 !px-5"
                  >
                    {loadingRole === "concierge" ? "Connecting..." : "Delivery Partner"} <Bike className="w-4 h-4" strokeWidth={2.5} />
                  </button>
                  <button
                    onClick={() => setShowAdminModal(true)}
                    className="dz-btn-dark inline-flex items-center gap-2 !text-sm !py-3 !px-5"
                  >
                    Admin <Lock className="w-4 h-4" strokeWidth={2.5} />
                  </button>
                </div>
